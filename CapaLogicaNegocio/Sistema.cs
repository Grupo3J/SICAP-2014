...
namespace CapaLogicaNegocio
{
    public class Sistema
    {
        ...
        public List<sp_ObtenerArbolResult> getArbol(string nick, string clave)
        {
        ...
        //    List<sp_ObtenerArbolResult> ar = SistemaCD.getarbol(nick,clave);
        //    foreach (sp_ObtenerArbolResult item in ar)
        //    {
